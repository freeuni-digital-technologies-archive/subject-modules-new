...
import {moduleProject, ProjectGroup, teamNameNotFoundError } from "main-module/modules/groupProject";
import * as path from "path";
import * as fs from "fs";
import * as fse  from "fs-extra";
import {ProjectsInfo} from "main-module/types/projectsInfo";
...
describe("resubmissions", () => {
    ...
    it(`delete old group and its files if group changes name (ie no members are left in the group`, () => {
        ...
        prepareSubmissions(newSubmissions)
